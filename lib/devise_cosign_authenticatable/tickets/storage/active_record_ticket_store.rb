    ...
    module Storage
      ...
      class ActiveRecordTicketStore < AbstractTicketStore
        ...
        def store_service_session_lookup(st, controller)
          raise COSIGNException, "No service_ticket specified." unless st
          raise COSIGNException, "No controller specified." unless controller
        ...
        def save_pgt_iou(pgt_iou, pgt)
          raise COSIGNClient::COSIGNException.new("Invalid pgt_iou") if pgt_iou.nil?
          raise COSIGNClient::COSIGNException.new("Invalid pgt") if pgt.nil?
        ...
        def retrieve_pgt(pgt_iou)
          ...
          raise COSIGNException, "Invalid pgt_iou specified. Perhaps this pgt has already been retrieved?" unless pgtiou
          pgt = pgtiou.pgt_id
